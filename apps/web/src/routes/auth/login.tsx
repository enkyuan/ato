        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <h1 className="font-semibold text-2xl text-fg">Sign in</h1>
          ...
          <div className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <label
                    htmlFor={rememberId}
                    className="cursor-pointer select-none text-fg text-sm"
                  >
                    Remember me
                  </label>
                </Checkbox>
                <p className="pl-6 text-muted-fg text-xs">
            ...
            <div className="text-muted-fg text-sm">
              ...
              <Link to="/auth/signup" className="font-medium text-secondary hover:underline">
                Sign up
              </Link>
            </div>
          </div>
